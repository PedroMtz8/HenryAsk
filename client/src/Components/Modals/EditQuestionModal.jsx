...
export default function EditQuestionModal({ editPost }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: `No se pudo editar la pregunta, inténtelo nuevamente.`,
        status: "error",
        duration: 4000,
        isClosable: true,
      })
          ...
          <ModalBody pb={6}>
            <form >
              ...
              <FormControl mt={4}>
                ...
                <Select name="module" onChange={handleChange} defaultValue={post.module}>

                  <option value="" disabled hidden>Selecciona el modulo</option>
                  {
                    modulos.map((m, i) => {
